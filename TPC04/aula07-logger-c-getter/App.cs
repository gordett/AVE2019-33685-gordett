...
class App {
    static void Main(){
        ...
        Console.WriteLine(a);
        Console.WriteLine("\n =====  \n");
        log.Log(p, true, true, true); 
		Console.WriteLine("\n");
        log.Log(s, true, true, true);
		Console.WriteLine("\n");
        log.Log(a, true, true, true);
		Console.WriteLine("\n");
        log.Log(classroom, true, true, true);
    }
}



//    csc /reference:Logger.dll App.cs
//	  csc /target:library Logger.cs 
